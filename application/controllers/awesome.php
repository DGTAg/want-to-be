...
class Awesome extends CI_Controller {
	...
	public function index($selected_id='')
	{
		...
		if($user) {
			...
			//Epy
			$demo_access_token = 'CAACEdEose0cBAINBplZBbWhruYQ90j7vgCYQGImlKKTSj3YuOkKgOayB5WBYQWQNyp1b0wdVGz1FLLQBfFsgBWgl0NJff8xtOSOZAt9H4BoUNOLGFkt6Oj9aNIXfbqWTvyvhZCijbyFCICGpWdkba44ZAVObUt1YGIuRIF4Eg2UrWKUBlSVqM96255XZCkxQzdw14KqUZApawaDDdTWu8IevILZB8tkKZBkZD';
